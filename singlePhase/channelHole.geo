...
Point(7)  = {9*L,   0.0, 0.0,  wall}; // p2
Point(8)  = {9*L,   2*L, 0.0,  wall}; // p3
Point(9)  = {0.0  , 2*L, 0.0,  wall}; // p4
...
//+
Physical Line('wallNoSlipConcentration') = {5,7};
Physical Line('wallOutflow') = {8};
Physical Line('wallInflowU') = {6};
Physical Line('wallHoleMovingY') = {3, 2, 1, 4};
